...
<head>
    ...
    <style class="page-css">
        ...
        header {
            padding: 50px 10px;
            background: linear-gradient(0deg, rgba(41, 50, 75, 0.7), rgba(41, 50, 75, 0.7)), url("https://www.sempersolaris.com/wp-content/uploads/2023/05/stars-1-140x57.png");
        ...
        .main-section {
            background-image: url("https://www.sempersolaris.com/wp-content/uploads/2023/06/07-23-SMP-Ben-Franklin-Horizontal-1400-x-800-.jpg");
        ...
        @media only screen and (max-width:600px) {
            ...
            .main-section {
                background-image: url("https://www.sempersolaris.com/wp-content/uploads/2023/06/07-23-SMP-Ben-Franklin-Vertical-800-x-1400.jpg");
...
<body <?php body_class(); ?>>
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            ...
            <header>
                <div class="header-inner-wrapper">
                    ...
                    <img src="https://www.sempersolaris.com/wp-content/uploads/2023/06/SMP-Up-to-7200-off.png" alt="">
                </div>
            </header>
            ...
            <div class="logo-wrapper">
                ...
                <img src="https://www.sempersolaris.com/wp-content/uploads/2023/06/semper-solaris-best-solar-company.png" alt="">
            </div>
                ...
                <div class="wrapper row">
                    ...
                    <div class="column">
                        <div class="form-wrapper" id="landingPage-form">
                            ...
                            <?= do_shortcode('[contact-form-7 id="38705" title="landing page"]'); ?>
                            <p style="line-height: 12px; text-align: center;margin-top:0;"><span style="color: rgb(0, 0, 0); font-size: 10px;margin-top:0;">By clicking, you agree to receive marketing emails, text messages, and phone calls are recorded. You may opt-out at anytime.</span></p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="star-bg-container">
                ...
                <img src="https://www.sempersolaris.com/wp-content/uploads/2023/05/05-24-2023-SMP-Webform-Badge-June-2023.png" alt="">
            </section>

            <section class="offer-section">
                <div class="offer-wrapper">
                    <img loading="lazy" class="img-1" src="https://www.sempersolaris.com/wp-content/uploads/2023/06/SMP-30-offer.png" alt="">
                    <img loading="lazy" class="img-2" src="https://www.sempersolaris.com/wp-content/uploads/2023/06/july-colors.png" alt="">
                    <img loading="lazy" class="img-3" src="https://www.sempersolaris.com/wp-content/uploads/2023/06/SMP-0-0-0-Offer-July2023.png" alt="">
                </div>
                <img loading="lazy" style="margin-top:4%;" width="450" src="https://www.sempersolaris.com/wp-content/uploads/2023/06/SMP-Tesla-Rebate-Internet-Coupon-2.png" alt="">
            ...
            <section class="call-now-section">
                ...
                <div class="img-wrapper">
                    <img loading="lazy" src="https://www.sempersolaris.com/wp-content/uploads/2023/05/HVAC-and-Nest.png" alt="">
                    <img loading="lazy" src="https://www.sempersolaris.com/wp-content/uploads/2023/05/Pink-Panther.png" alt="">
                    <img loading="lazy" src="https://www.sempersolaris.com/wp-content/uploads/2023/05/SMP-Web-Assets_Semper-Cares-1-1536x1536.png" alt="">
                    <img loading="lazy" src="https://www.sempersolaris.com/wp-content/uploads/2023/05/SMP-Web-Assets_Owners-1-410x150.png" alt="">
        ...
        <footer>
            <p>*On approved credit. Savings based on system size, some restrictions apply. Present downloadable Digital Coupon at time of appointment. **30 percent federal tax credit based on eligibility, consult your tax advisor. New customers only. Call or see website for details, www.sempersolaris.com. ***Call or see website for details <a style="color:white !important;" href="https://www.tesla.com/support/energy/powerwall/order/rebate#combined-offer-incentive" target="_blank">https://www.tesla.com/support/energy/powerwall/order/rebate#combined-offer-incentive</a>.</p>
            ...
            <div id="disclaimerArea" class="disclaimerArea" style="color:white !important">
                <div class="text-center mx-auto container " role="contentinfo" aria-label="Site issue" style="max-width: 1000px; margin:auto;">
                    ...
                    <p id="disclaimerArea">&copy;<?= date('Y') ?> Semper Solaris. All Rights Reserved. | CSLB #978152 | <a style="color:white;" href="https://www.sempersolaris.com/privacy-notice/">Privacy Policy </a> | Call +1 (888) 210-3366 </p>
