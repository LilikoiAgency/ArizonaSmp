...
<header>
    <div class="text-center p-2">
        <img class="m-auto" width="250" src="https://smpbackup.wpengine.com/wp-content/themes/semper-solaris/dist/img/logo/semper-solaris_logo-hd.svg" alt="">
    </div>
    <div class="text-center p-2" style="background-color: #004c97; color:white;">
        <h2 class="m-auto top-callout">Top Volume Residential Solar + Battery Storage Installer in America </h2>
    </div>
</header>
    ...
    <div class="row m-auto pt-md-4 pb-md-5" style="max-width: 1100px;">
        <div class="header-inner-wrapper col-md-7 pt-md-4">
            ...
            <p class="left d-none d-md-block">
                Are your energy bills skyrocketing every month? Say goodbye to outrageous electricity bills in <?php echo $content_array['city-name'] ?>. Go solar and start saving! Act now and cut your electric bill up to half!
            </p>
