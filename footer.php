...
<footer>
    ...
    <div id="disclaimerArea" class="disclaimerArea" style="color:white!important">
        <div class="text-center mx-auto container text-gray" role="contentinfo" aria-label="Site issue" style="max-width:1000px">
            ...
            *On approved credit. Up to $500 reimbursement or discounted from sales price. 30 percent federal tax credit based on eligibility, consult your tax advisor. **On approved credit. Savings based on size of roof. Cool Roof upgrade with roof replacement only. ***Must purchase a complete heating system. †Present this at the time of your appointment. ‡Unlimited referrals accepted. Maximum awarded amount per new customer is $550 for referrals that purchase. Referral name must be supplied by referrer, referral amount paid after completion of installation and payment. FOR ALL OFFERS: New customers only, some restrictions apply. Cannot be combined with other offers. #1 Volume Residential Solar + Battery based on the volume of residential installations. For more information on warranties call or see website for details https://www.sempersolaris.com/warranties/. 
