...
<footer>
    ...
    <div id="disclaimerArea" class="disclaimerArea" style="color:white!important">
        <div class="text-center mx-auto container text-gray" role="contentinfo" aria-label="Site issue" style="max-width:1000px">
            ...
            §No hard credit pull *30 percent federal tax credit based on eligibility, consult your tax advisor. On approved credit. **On approved credit. (Battery Storage will have the 0 Financing Offer). ^Savings based on size of roof. On approved credit. ‡Payment based on system size of unit. On approved credit. †For all warranties please go to <a href="https://www.sempersolaris.com/warranties/">www.sempersolaris.com/warranties</a>. ~Present this at the time of your appointment. One per household, minimum 8 panel new system. §Maximum awarded amount per new customer is $550 for referrals that purchase. ◊Maximum awarded amount per new customer is $200 for referrals that purchase. For all referrals: Referral name must be supplied by referrer, referral amount paid after completion of complete system installation and payment. Unlimited referrals accepted. For all offers: Cannot be combined with any other offers. New customers only, some restrictions apply. For further details please call
